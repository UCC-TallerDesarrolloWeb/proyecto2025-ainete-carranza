...
export const defaultRecipes = {
  ensalada: {
    ...
    descripcion: 'ideal para almuerzos ligeros o cenas rápidas. lista en menos de 10 minutos con ingredientes frescos y crocantes.',
    datos: ['10 minutos', '2 porciones', 'rápida & económica'],
    imagen: {
      src: '/image-ensalada.jpg',
      alt: 'bowl de ensalada verde con hojas, semillas y vinagreta'
    },
    categorias: ['rapidas', 'economicas'],
    ingredientes: [
  ...
  'power-bowl': {
    ...
    descripcion: 'un bowl completo con proteínas, carbohidratos y grasas saludables. perfecto después de entrenar o para un almuerzo consistente.',
    datos: ['25 minutos', '2 porciones', 'proteico'],
    imagen: {
      src: '/imagen-bowl-proteico.jpg',
      alt: 'bowl con pollo grillado, quinoa y vegetales'
    },
    categorias: ['proteicas'],
    ingredientes: [
  ...
  batido: {
    ...
    descripcion: 'un licuado cremoso con carbohidratos y antioxidantes para arrancar el día con energía o recuperar después de entrenar.',
    datos: ['5 minutos', '1 porción grande', 'rápida'],
    imagen: {
      src: '/imagen-batido-energetico.jpg',
  ...
  wrap: {
    ...
    descripcion: 'una opción vegetal, liviana y con mucha textura gracias a los garbanzos crocantes y las verduras frescas.',
    datos: ['15 minutos', '2 wraps', 'vegetariana'],
    imagen: {
      src: '/imagen-wrap-veggie.jpg',
  ...
  desayuno: {
    ...
    descripcion: 'tostadas integrales con huevo y palta, un combo equilibrado para arrancar el día con energía y saciedad.',
    datos: ['12 minutos', '1 porción', 'proteico & económico'],
    imagen: {
      src: '/imagen-desayuno-proteico.jpg',
      alt: 'tostadas integrales con huevo y palta'
    },
    categorias: ['proteicas', 'economicas'],
    ingredientes: [
  ...
  snack: {
    ...
    descripcion: 'una mezcla horneada de frutos secos y garbanzos especiados. ideal para llevar en un frasco y tener energía entre comidas.',
    datos: ['30 minutos', '4 porciones', 'proteico & rápido'],
    imagen: {
      src: '/imagen-snack-crocante.jpg',
      alt: 'frutos secos y garbanzos especiados en frasco'
    },
    categorias: ['rapidas', 'proteicas'],
    ingredientes: [
...
export const recipesArray = Object.values(defaultRecipes);
